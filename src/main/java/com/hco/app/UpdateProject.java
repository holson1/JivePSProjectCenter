...
public class UpdateProject extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		//get other POST parameters and sanitize
		...
		if(! message.isEmpty()) {
			...
			response.sendRedirect("../home/project/?pid=" + pid);
			return;
		}
		...
		query = "UPDATE project_info " +
				"SET uid = ?, project_name = ?, client = ?, sale_amount = ?, start_date = ?, " +
				"end_date = ?, details = ?, status = ? " +
				"WHERE pid = " + pid;
